...
<div id="enTete">
    <div id="versFichePersonnage" class="vers">
        <a id="lienVersFichePersonnage" class="lienVers"
           href="./index.php?perso=<?php echo $_SESSION['perso']; ?>&action=fichePerso">Retour à la fiche du perso</a>
    </div>
...
<script>
    $(document).ready(function () {
        affichageMessages("<?php echo $_SESSION['perso']; ?>");
        allMessagesLue("<?php echo $_SESSION['perso']; ?>");
        evenButtonSendMessageMJClick("<?php echo $_SESSION['perso']; ?>", "#sendMessageMJ");
