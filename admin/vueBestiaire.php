    <div id="Corps" class="ficheMonstre">
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-2 column glyphicon glyphicon-isCacher">
                <input type="checkbox" name="isCacher" id="isCacher" class="inputCacheMonstre" data-on-color="success" data-off-color="danger" data-label-text="Cacher">
            </div>
        </div>
        <div class="row clearfix">
    ...
    <script>
        $(document).ready(function(){
            var IDMonstre = "<?php if (isset($_SESSION['monstre'])){ echo $_SESSION['monstre']; }?>";
            
            $("#isCacher").bootstrapSwitch('state', false);
            evenSelectListeMonstreChange();
            evenButtonAddMonstreClick();
