            ...
            <div class="col-md-4 column">
                <div class="input-group">
                    ...
                    <select class="form-control" id="listePersonnage">
                        <option value="" class="defautValue" <?php if ($personnage == "" && !isset($_SESSION['perso'])){ ?>selected="selected"<?php } ?>>selectionner un perso</option>
    ...
    <script>
        $(document).ready(function(){
            var IDPersonnage = "<?php if (isset($_SESSION['perso'])){ echo $_SESSION['perso']; }?>";
    
            affichagePersonnage(IDPersonnage);
            evenSelectListePersonnageChange();
            evenButtonAddPersonnageClick();
